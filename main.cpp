...
int main(int argc, char** argv)
{
    ...
    double memory = 0.001;
    double bf_memory = 0.03;

    int w = memory * 1024 * 1024 * 8.0 / COUNTER_SIZE;
    int bf_w = bf_memory * 1024 * 1024 * 8.0;
    ...
    CMSketch_BloomFilter *bf_sketch;
    ...
    bf_sketch = new CMSketch_BloomFilter(w / LOW_HASH_NUM, LOW_HASH_NUM, bf_w / LOW_HASH_NUM, BF_HASH_NUM);
    for(int i = 0; i < 200000; i++)
    {
        bf_sketch->Insert(insert[i], i);
    }
